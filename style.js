...
const search = () =>{
  ...
  const name = storeitems.getElementsByTagName("h5");
...
const searchitem = () =>{
  ...
  const b_name = store_items.getElementsByTagName("h5");

  for(var i=0; i < p_name.length; i++){
    let matchs = product[i].getElementsByTagName('h6')[0];
  ...
  for(var i=0; i < b_name.length; i++){
    let matchs = product[i].getElementsByTagName('h5')[0];
